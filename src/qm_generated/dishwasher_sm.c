/*$file${../qm_generated::dishwasher_sm.c} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*
...
/*$define${AOs::Dishwasher} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
...
QState Dishwasher_Startup(Dishwasher * const me) {
    ...
    switch (Q_SIG(me)) {
        /*${AOs::Dishwasher::SM::Operating::Startup} */
        case Q_ENTRY_SIG: {
            QActive_armX(&me->super, 0U, WARMUP_TIMEOUT_TICKS, 0U);
            Dishwasher_startup((QActive *) me);
            status_ = Q_HANDLED();
            break;
        }
        /*${AOs::Dishwasher::SM::Operating::Startup::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            /*${AOs::Dishwasher::SM::Operating::Startup::Q_TIMEOUT::[BSP_isDoorClosed()]} */
            if (BSP_isDoorClosed()) {
                status_ = Q_TRAN(&Dishwasher_DoorClosed);
            }
            /*${AOs::Dishwasher::SM::Operating::Startup::Q_TIMEOUT::[else]} */
            else {
                status_ = Q_TRAN(&Dishwasher_DoorOpen);
            }
            break;
