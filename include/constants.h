...
enum
{
    ...
    WARMUP_TIMEOUT_TICKS = 2U * TICKS_PER_SEC,
    TIMEDFILL_TIMEOUT_TICKS = 140U * TICKS_PER_SEC,
    WASHCYCLE_TIMEOUT_TICKS = 41 * TICKS_PER_SEC,
    DWELL_TIMEOUT_TICKS = 7 * TICKS_PER_SEC,
    RINSECYCLE_TIMEOUT_TICKS = 17 * TICKS_PER_SEC,
